...
export PATH="$PATH:/home/szokeb/.openmpi/bin/"
export LD_LIBRARY_PATH="$LD_LIBRARY_PATH:/home/szokeb/.openmpi/lib"
export C_INCLUDE_PATH="$C_INCLUDE_PATH:/home/szokeb/.openmpi/include"

echo "localhost cpu=4" > OpenMPIhosts
